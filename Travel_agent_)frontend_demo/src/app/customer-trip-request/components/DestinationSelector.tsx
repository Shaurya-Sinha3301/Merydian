    ...
    <div className="space-y-2">
      ...
      <div className="relative">
        <input
          ...
          className={`w-full rounded-2xl neu-input px-4 py-3 pr-10 text-foreground placeholder:text-muted-foreground focus:outline-none focus:shadow-neu-inset transition-smooth ${
