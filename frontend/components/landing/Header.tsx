...
export default function Header() {
  ...
  return (
    <motion.header
      ...
      className={`fixed top-8 left-1/2 -translate-x-1/2 z-50 transition-all duration-500 ease-out backdrop-blur-md rounded-full flex items-center justify-between border border-white/10 ${
        !scrolled
